...
public class HSThemeActivity extends Activity {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    // You initialize the library by calling Helpshift.install(APPLICATION_CONTEXT, API_KEY, DOMAIN,
    ...
    helpButton.setOnClickListener(new OnClickListener() {
        ...
        public void onClick(View view) {
          Helpshift.showFAQs(HSThemeActivity.this);
        }
      });
    ...
    reportIssueButton.setOnClickListener(new OnClickListener() {
        @Override
        public void onClick(View view) {
          Helpshift.showConversation(HSThemeActivity.this);
        }
      });
    ...
    faqSectionButton.setOnClickListener(new OnClickListener() {
        @Override
        public void onClick(View view) {
          Helpshift.showFAQSection(HSThemeActivity.this, "SECTION_PUBLISH_ID");
        }
      });
    ...
    singleFaqButton.setOnClickListener(new OnClickListener() {
        @Override
        public void onClick(View view) {
          Helpshift.showSingleFAQ(HSThemeActivity.this, "QUESTION_PUBLISH_ID");
        }
      });
  }
}
